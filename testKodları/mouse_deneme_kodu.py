...
# -*- coding: utf-8 -*-
"""
Mouse movement test with simple pupil detection and 5-direction calibration.
"""
...
class TargetOverlay(QWidget):
    ...
    def paintEvent(self, event):
        ...
        cx = int(self.size // 2)
        painter.drawEllipse(cx - dot_r, cx - dot_r, dot_r * 2, dot_r * 2)
...
def main():
    ...
    ap.add_argument("--hold", type=float, default=0.5, help="Hedef üzerinde bekleme süresi (sn)")
    ap.add_argument("--radius", type=int, default=70, help="Hedef kabul yarıçapı (px)")
